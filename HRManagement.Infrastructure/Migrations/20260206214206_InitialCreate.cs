    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LeaProfileId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistrictCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EmployeeCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TuitionEligible = table.Column<bool>(type: "bit", nullable: false),
                    Approved = table.Column<bool>(type: "bit", nullable: false),
                    MaintenanceOfLicense = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_LeaProfileId_Description_StartDate",
                table: "Courses",
                columns: new[] { "LeaProfileId", "Description", "StartDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseTypes_LeaProfileId_Description",
                table: "CourseTypes",
                columns: new[] { "LeaProfileId", "Description" },
                unique: true);
